...
class _LoginPageState extends State<LoginPage> {
  ...
  final String backgroundImageUrl =
      'https://img.freepik.com/free-vector/privacy-policy-concept-illustration_114360-7853.jpg?w=996&t=st=1702733703~exp=1702734303~hmac=0e8940e434fe247328ad91bee0f8154fd747c5dc7def912b641a33d0df4f24ef';
      ...
      if (loggedInUser != null) {
        if (loggedInUser.role == 'alumini') {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  AlumniConnectPage(currentUserUid: loggedInUser.uid),
            ),
          );
