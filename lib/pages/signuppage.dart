      ...
      if (e is FirebaseAuthException) {
        switch (e.code) {
          ...
          case 'email-already-in-use':
            errorMessage =
                'The account already exists for that email. Please sign in or use a different email.';
            break;
          case 'invalid-email':
            errorMessage =
                ...
                children: [
                  ...
                  TextField(
                    ...
                    onChanged: (value) {
                      ...
                      if (_displayNameController.text.isNotEmpty) {
                        setState(() {
                          ...
                          _displayNameError =
                              _validateName(_displayNameController.text);
                        });
                      }
                    },
                    decoration: InputDecoration(
                      labelText: 'Name',
                      errorText:
                          _displayNameError, // Use a variable to store the error message
                    ),
                  ),
                  SizedBox(height: 8.0),
                  TextField(
                    ...
                    child: TextField(
                      ...
                      onChanged: (value) {
                        if (_graduationYearController.text.isNotEmpty) {
                          setState(() {
                            _graduationYearError = _validateGraduationYear(
                    ...
                    child: TextField(
                      ...
                      onChanged: (value) {
                        if (_currentJobController.text.isNotEmpty) {
                          setState(() {
                            _currentJobError =
                                _validateCurrentJob(_currentJobController.text);
                          });
                        }
                      },
                      decoration: InputDecoration(
